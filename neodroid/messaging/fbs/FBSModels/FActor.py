...
def FActorAddActorName(builder, actorName): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(actorName), 0)
def FActorAddAlive(builder, alive): builder.PrependBoolSlot(1, alive, 0)
def FActorAddActuators(builder, actuators): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(actuators), 0)

...
def FStateAddObservables(builder, observables): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(observables), 0)
def FStateStartObservablesVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def FStateAddUnobservables(builder, unobservables): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(unobservables), 0)
...
def FStateAddTerminationReason(builder, terminationReason): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(terminationReason), 0)
...
def FStateAddLastReaction(builder, lastReaction): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(lastReaction), 0)
def FStateAddExtraSerialisedMessage(builder, extraSerialisedMessage): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(extraSerialisedMessage), 0)

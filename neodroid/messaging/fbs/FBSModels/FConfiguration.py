...
def FConfigurationStart(builder):
    builder.StartObject(2)


def FConfigurationAddConfigurableName(builder, configurableName):
    builder.PrependUOffsetTRelativeSlot(
        0, flatbuffers.number_types.UOffsetTFlags.py_type(configurableName), 0
    )


def FConfigurationAddConfigurableValue(builder, configurableValue):
    builder.PrependFloat64Slot(1, configurableValue, 0.0)


def FConfigurationEnd(builder):

...
def FlatBufferReactionAddMotions(builder,
    ...
    0, flatbuffers.number_types.UOffsetTFlags.py_type(motions), 0)
...
def FlatBufferReactionAddConfigurations(builder,
                                        configurations): builder.PrependUOffsetTRelativeSlot(
    1, flatbuffers.number_types.UOffsetTFlags.py_type(configurations), 0)


def FlatBufferReactionStartConfigurationsVector(builder,
                                                numElems): return builder.StartVector(
    4, numElems, 4)


def FlatBufferReactionAddReset(builder, reset): builder.PrependBoolSlot(2,
                                                                        reset,
                                                                        0)

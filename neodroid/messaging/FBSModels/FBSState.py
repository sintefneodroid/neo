...
def FBSStateAddUnobservables(builder, unobservables): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(unobservables), 0)

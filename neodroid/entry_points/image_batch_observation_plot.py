...
from draugr.torch_utilities import float_chw_to_hwc_uint_tensor, to_tensor, uint_hwc_to_chw_float_tensor
...
def main():
    ...
    inputs = float_chw_to_hwc_uint_tensor(reverse_torch_vision_normalize_batch_nchw(inputs))

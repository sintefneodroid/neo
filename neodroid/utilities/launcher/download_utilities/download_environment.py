...
class DownloadProgress(tqdm):
    ...
    def __init__(
        self, unit="B", unit_scale=True, min_iters=1, desc="Download", **kwargs
    ):
        super().__init__(
            unit=unit, unit_scale=unit_scale, miniters=min_iters, desc=desc, **kwargs
        )
...
"""
    ...
    download_format = (
        "https://drive.google.com/uc?export=download&confirm=-oy0&id={FILE_ID}"
    )

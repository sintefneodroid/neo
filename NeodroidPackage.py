  ...
  def entry_points(self):
    return {
      'console_scripts':[
        ...
        'neodroid = executables.minimal.action_space_sampling:main'
        'neodroid-mab = executables.minimal.multi_armed_bandit:main',
        'neodroid-grd = executables.minimal.grid_world:main',
        ]
      }

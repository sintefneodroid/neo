...
from gui_components import EnvironmentStateColumn, ReactionColumn, StaturBar
...
class NeoGUI(App):
    ...
    def build(self):
        ...
        self.action_column = ReactionColumn(on_step_callback=self._on_step_callback,
        ...
        self.columns.add_widget(self.action_column)
